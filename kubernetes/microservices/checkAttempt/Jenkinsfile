    ...
    stages {
        stage('Clean') {
            ...
            steps {
              dir('docker') {
                ...
                docker image ls
                docker ps
                docker rmi djtoler/qz-ms-checkAttempt:latest || true
        ...
        stage('BuildBackImage') {
            ...
            steps {
              dir('docker') {
                ...
                cd back && pwd && docker build --no-cache -t djtoler/qz-ms-checkAttempt:latest .
        ...
        stage('DockerHubPush') {
            ...
            steps {
                ...
                sh 'docker image ls'
                sh 'sudo docker push djtoler/qz-ms-checkAttempt:latest'
            }
        }
