    ...
    stages {
        stage('Clean') {
            ...
            steps {
              dir('docker') {
                ...
                docker image ls
                docker ps
                docker rmi djtoler/qz-ms-route:latest || true
        ...
        stage('BuildBackImage') {
            ...
            steps {
              dir('docker') {
                ...
                cd back && pwd && docker build --no-cache -t djtoler/qz-ms-route:latest .
        ...
        stage('DockerHubPush') {
            ...
            steps {
                ...
                sh 'docker image ls'
                sh 'sudo docker push djtoler/qz-ms-route:latest'
            }
        }
